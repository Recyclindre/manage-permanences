        ...
        {appContext.selectedComposter ? (
          <Fragment>
            <Typography component="h1" variant="h3" gutterBottom>
              {appContext.selectedComposter.name}
            </Typography>

            <Tabs
              value={openedTab}
              onChange={(event, openedTab) =>
                this.handleChange(event, openedTab)
              }
            ...
            {openedTab === 0 && (
              <Fragment>
                <Markdown
                  source={appContext.selectedComposter.short_description}
                />
